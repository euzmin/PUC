...
class TONet(nn.Module):
    ...
    def criterion(self, y_hat, t_hat, eps, y_out, y, t, alpha, beta, w=1.0):
        ...
        return to_loss + beta * targeted_regularization
    def predict(self, x):
    ...
    def train_model(self, opt, train_dataloader, valid_data, test_data, args, exp=None, best_model_path=None):
        ...
        for epoch in range(args.epochs):
            for i, sample in enumerate(train_dataloader):
                ...
                y_hat, t_hat, eps, y_out = self(xt)
                loss = self.criterion(y_hat, t_hat, eps, y_out, y, t, args.alpha, args.beta, w)
                loss.backward()
                opt.step()
